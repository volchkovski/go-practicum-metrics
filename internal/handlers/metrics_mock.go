...
// Source: internal/handlers/metrics.go
//
// Generated by this command:
//
//	mockgen -source=internal/handlers/metrics.go -destination=internal/handlers/metrics_mock.go -package=handlers
//
...
func (m *MockMetricsReadWriter) ReadAllCounters() map[string]int64 {
	m.ctrl.T.Helper()
...
func (m *MockMetricsReadWriter) ReadAllGauges() map[string]float64 {
	m.ctrl.T.Helper()
...
// ReadAllCounters mocks base method.
func (m *MockAllMetricsReader) ReadAllCounters() map[string]int64 {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ReadAllCounters")
	ret0, _ := ret[0].(map[string]int64)
	return ret0
...
// ReadAllGauges mocks base method.
func (m *MockAllMetricsReader) ReadAllGauges() map[string]float64 {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ReadAllGauges")
	ret0, _ := ret[0].(map[string]float64)
	return ret0
...
// MockGaugeWriter is a mock of GaugeWriter interface.
type MockGaugeWriter struct {
	ctrl     *gomock.Controller
	recorder *MockGaugeWriterMockRecorder
	isgomock struct{}
}

// MockGaugeWriterMockRecorder is the mock recorder for MockGaugeWriter.
type MockGaugeWriterMockRecorder struct {
	mock *MockGaugeWriter
}

// NewMockGaugeWriter creates a new mock instance.
func NewMockGaugeWriter(ctrl *gomock.Controller) *MockGaugeWriter {
	mock := &MockGaugeWriter{ctrl: ctrl}
	mock.recorder = &MockGaugeWriterMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use.
func (m *MockGaugeWriter) EXPECT() *MockGaugeWriterMockRecorder {
	return m.recorder
}

// WriteGauge mocks base method.
func (m *MockGaugeWriter) WriteGauge(arg0 string, arg1 float64) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "WriteGauge", arg0, arg1)
	ret0, _ := ret[0].(error)
	return ret0
...
// WriteGauge indicates an expected call of WriteGauge.
func (mr *MockGaugeWriterMockRecorder) WriteGauge(arg0, arg1 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "WriteGauge", reflect.TypeOf((*MockGaugeWriter)(nil).WriteGauge), arg0, arg1)
}

// MockCounterWriter is a mock of CounterWriter interface.
type MockCounterWriter struct {
	ctrl     *gomock.Controller
	recorder *MockCounterWriterMockRecorder
	isgomock struct{}
}

// MockCounterWriterMockRecorder is the mock recorder for MockCounterWriter.
type MockCounterWriterMockRecorder struct {
	mock *MockCounterWriter
}

// NewMockCounterWriter creates a new mock instance.
func NewMockCounterWriter(ctrl *gomock.Controller) *MockCounterWriter {
	mock := &MockCounterWriter{ctrl: ctrl}
	mock.recorder = &MockCounterWriterMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use.
func (m *MockCounterWriter) EXPECT() *MockCounterWriterMockRecorder {
	return m.recorder
}

// WriteCounter mocks base method.
func (m *MockCounterWriter) WriteCounter(arg0 string, arg1 int64) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "WriteCounter", arg0, arg1)
	ret0, _ := ret[0].(error)
	return ret0
...
// WriteCounter indicates an expected call of WriteCounter.
func (mr *MockCounterWriterMockRecorder) WriteCounter(arg0, arg1 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "WriteCounter", reflect.TypeOf((*MockCounterWriter)(nil).WriteCounter), arg0, arg1)
}

// MockGaugeReader is a mock of GaugeReader interface.
type MockGaugeReader struct {
	ctrl     *gomock.Controller
	recorder *MockGaugeReaderMockRecorder
	isgomock struct{}
}

// MockGaugeReaderMockRecorder is the mock recorder for MockGaugeReader.
type MockGaugeReaderMockRecorder struct {
	mock *MockGaugeReader
}

// NewMockGaugeReader creates a new mock instance.
func NewMockGaugeReader(ctrl *gomock.Controller) *MockGaugeReader {
	mock := &MockGaugeReader{ctrl: ctrl}
	mock.recorder = &MockGaugeReaderMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use.
func (m *MockGaugeReader) EXPECT() *MockGaugeReaderMockRecorder {
	return m.recorder
}

// ReadGauge mocks base method.
func (m *MockGaugeReader) ReadGauge(arg0 string) (float64, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ReadGauge", arg0)
	ret0, _ := ret[0].(float64)
	ret1, _ := ret[1].(error)
...
// ReadGauge indicates an expected call of ReadGauge.
func (mr *MockGaugeReaderMockRecorder) ReadGauge(arg0 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ReadGauge", reflect.TypeOf((*MockGaugeReader)(nil).ReadGauge), arg0)
}

// MockCounterReader is a mock of CounterReader interface.
type MockCounterReader struct {
	ctrl     *gomock.Controller
	recorder *MockCounterReaderMockRecorder
	isgomock struct{}
}

// MockCounterReaderMockRecorder is the mock recorder for MockCounterReader.
type MockCounterReaderMockRecorder struct {
	mock *MockCounterReader
}

// NewMockCounterReader creates a new mock instance.
func NewMockCounterReader(ctrl *gomock.Controller) *MockCounterReader {
	mock := &MockCounterReader{ctrl: ctrl}
	mock.recorder = &MockCounterReaderMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use.
func (m *MockCounterReader) EXPECT() *MockCounterReaderMockRecorder {
	return m.recorder
}

// ReadCounter mocks base method.
func (m *MockCounterReader) ReadCounter(arg0 string) (int64, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ReadCounter", arg0)
	ret0, _ := ret[0].(int64)
	ret1, _ := ret[1].(error)
...
// ReadCounter indicates an expected call of ReadCounter.
func (mr *MockCounterReaderMockRecorder) ReadCounter(arg0 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ReadCounter", reflect.TypeOf((*MockCounterReader)(nil).ReadCounter), arg0)
}
